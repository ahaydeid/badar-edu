...
export default function KegiatanTahunanTable({
    data,
    page,
    totalPages,
    rowsPerPage,
                            ...
                            {data.length === 0 ? (
                                <tr>
                                    <td colSpan={8} className="p-4 text-center">
                                        Tidak ada data kegiatan tahunan.
                                    </td>
                                </tr>
                            ) : (
                                data.map((k: any) => (
